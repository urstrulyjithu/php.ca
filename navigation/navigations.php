...
<title><?php echo $title;?> | lovely professional univesity</title>
...
#download {
    top: 340px;
    background-color: rgb(66, 68, 62);
}

#about {
    top: 420px;
    background-color: rgb(118, 120, 115);
}
#login {
    top: 500px;
    background-color: rgb(153, 155, 149);
}
...
<section id="title-header">
  <div class="title">  
     <p>pennywise tutorials <br>lovely professional university
      <br>jalandhar, punjab</p>
...
<footer  >
    <p align="left">&copy; lovely professional Unversity</p>
</footer>
</section>
